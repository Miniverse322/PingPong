...
pen.hideturtle()
pen.goto(0, 260)
pen.write("Stefan: 0  Nes: 0", align="center", font=("Courier", 24, "normal"))
...
while True:
    ...
    if ball.xcor() > 390:
        ...
        score_a += 1
        pen.clear()
        pen.write("Stefan A: {}  Nes B: {}".format(score_a, score_b), align="center", font=("Courier", 24, "normal"))
